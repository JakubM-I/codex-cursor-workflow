# Shared Agent Materials

This directory is for materials that are useful to more than one agent.

Use it for shared skills, checklists, conventions, prompts, artifact contracts, and reference notes that should be available across the Codex-Cursor workflow.

Do not put tool-specific instructions here when they only apply to Codex or Cursor.
